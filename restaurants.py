...
Here are some example dictionaries. These correspond to the information
in restaurants_small.txt.
...
[[82, 'Queen St. Cafe'], [7], 'Dumplings R Us']]
'''
...
def recommend(file, price, cuisines_list):
    ...
    Find restaurants in file that are priced according to price and
    that are tagged with any of the items in cuisines_list. Return
    a list of lists of the form [rating%, restaurant name], sorted
    by rating%.
    '''
    ...
    # Price: look up the list o frestaurant names for the request price.
